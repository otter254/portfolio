...
export default () => {
    ...
    setTimeout(() => {
      ...
      tl.add(gsap.to("#js-mvfade01", { opacity:1, y:0 ,duration: 1 }));
      tl.add(gsap.to("#js-mvfade02", { opacity:1, y:0 ,duration: 1 }, "+=0.8"));
      tl.add(gsap.to("#js-mvfade03", { opacity:1, y:0 ,duration: 1 }, "+=0.8"));
    }, 2500);
}
